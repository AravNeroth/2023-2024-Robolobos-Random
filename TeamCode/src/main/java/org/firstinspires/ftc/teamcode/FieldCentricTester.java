...
public class FieldCentricTester extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // imports the IMU
        BNO055IMU imu = hardwareMap.get(BNO055IMU.class, "cIMU");
        ...
        while(opModeIsActive()) {
            ...
            // variable multi is for the speed multiplier of the motors
            ...
            FL.setPower(multi * frontLeftPower);
            BL.setPower(multi * backLeftPower);
            FR.setPower(multi * frontRightPower);
            BR.setPower(multi * backRightPower);
        }
